    ...
    <main :class="{ collapsed: !onHomePage }">
      ...
      <div class="wrapper" v-if="onHomePage">
        <section class="hero">
          ...
          <svg class="wordmark" version="1.1" viewBox="0 0 181.29895 41.661442" id="svg88"
