<template>
  <section class="app-page document-page">
    <article>
      ...
      <p>
        Administratorem Danych Osobowych (dalej Administrator) jest firma "F.H.U. Zołza Kinga
        Dudzik", prowadząca działalność pod adresem: 34-602 Laskowa 916, o nadanym numerze
        identyfikacji podatkowej (NIP): 7372228022, świadcząca usługi drogą elektroniczną za
      ...
      <ul>
        <li>
          <p>
            <span class="strong">Adres pocztowy</span> - F.H.U. Zołza Kinga Dudzik, 34-602 Laskowa
            916
          </p>
        </li>
        <li>
          <p>
            <span class="strong">Adres poczty elektronicznej </span> - zolza.hairstyles@gmail.com
          </p>
        </li>
        <li>
      ...
      <p>
        W serwisie przetwarzane są <span class="strong">dane osobowe zwykłe</span>, podane
        dobrowolnie przez osoby, których dotyczą<span class="small new-line">
          (Np. imię i nazwisko, login, adres e-mail, telefon, adres IP, itp.)</span
        >
      </p>
      <p>
        Szczegółowy zakres przetwarzanych danych dostępny jest w
        <a href="https://zolza-hairstyles.pl/privacy-policy">Polityce Prywatności</a>.
      </p>
      <h2>Jakie są cele przetwarzania przez nas danych?</h2>
      <p>
        Dane osobowe dobrowolnie podane przez Użytkowników są przetwarzane w jednym z następujących
        celów:
      </p>
      <ul>
        <li>
        ...
        <li>
          Komunikacji Administratora z Użytkownikami w sprawach związanych z Serwisem oraz ochrony
          danych
        </li>
      ...
      <ul>
        <li>
          ...
          <ul>
            <li>
              art. 6 ust. 1 lit. a<span class="small new-line"
                >osoba, której dane dotyczą wyraziła zgodę na przetwarzanie swoich danych osobowych
                w jednym lub większej liczbie określonych celów</span
              >
            </li>
            <li>
              art. 6 ust. 1 lit. b<span class="small new-line"
                ...
                zawarciem umowy</span
              >
            </li>
            <li>
              art. 6 ust. 1 lit. f<span class="small new-line"
                >przetwarzanie jest niezbędne do celów wynikających z prawnie uzasadnionych
                interesów realizowanych przez administratora lub przez stronę trzecią</span
              >
            </li>
          </ul>
        </li>
      ...
      <ul>
        <li>
          ...
          przetwarzania jest nasz uzasadniony interes (art. 6 ust. 1 lit. f) RODO) polegający na
      ...
      <p>
        ...
        usługi w ramach prowadzonego serwisu przez Administratora. Są one usuwane lub anonimizowane
        w okresie do <span class="strong">30 dni od chwili zakończenia świadczenia usług</span> (np.
        usunięcie zarejestrowanego konta użytkownika, wypisanie z listy Newsletter, itp.)
      </p>
      <p>
        W wyjątkowych sytuacjach, w celu zabezpieczenie prawnie uzasadnionego interesu realizowanego
        przez Administratora, okres ten może ulec wydłużeniu. W takiej sytuacji Administrator będzie
        przechowywał wskazane dane, od czasu żądania ich usunięcia przez Użytkownika, nie dłużej niż
        przez okres 3 lat w przypadku naruszenia lub podejrzenia naruszenia zapisów regulaminu
      ...
      <p>
        Przetwarzanie danych może jednak być powierzone innym podmiotom, realizującym usługi na
        rzecz Administratora w celu utrzymania działalności Serwisu.
      </p>
      ...
      <p>
        Dane osobowe <span class="strong">nie będą przekazywane poza Unię Europejską</span>, chyba
        że zostały opublikowane na skutek indywidualnego działania Użytkownika (np. wprowadzenie
        komentarza lub wpisu), co sprawi, że dane będą dostępne dla każdej osoby odwiedzającej
        serwis.
      </p>
      <h2>Czy dane osobowe będą podstawą zautomatyzowanego podejmowania decyzji?</h2>
      <p>
        Dane osobowe <span class="strong">nie będą wykorzystywane</span> do zautomatyzowanego
      ...
      <ul>
        <li>
          <p>
            <span class="strong">Prawo dostępu do danych osobowych</span>
            <span class="new-line">
        ...
        <li>
          <p>
            <span class="strong">Prawo do sprostowania danych osobowych</span>
            <span class="new-line">
              ...
              osobowych, realizowane za pośrednictwem panelu użytkownika dostępnego po zalogowaniu i
              narzędzi umożliwiających dostęp do konta w przypadku zapomnianego hasła.</span
            >
          </p>
        </li>
        <li>
          <p>
            <span class="strong">Prawo do usunięcia danych osobowych</span>
            <span class="new-line bottom-spacing">
              Użytkownikom przysługuje prawo żądania od Administratora niezwłocznego usunięcia
              danych osobowych, realizowane na żądanie złożone do Administratora.</span
            >
            W przypadku kont użytkowników, usunięcie danych polega na anonimizacji danych
            umożliwiających identyfikację Użytkownika.
          </p>
        </li>
        <li>
          <p>
            <span class="strong">Prawo do ograniczenia przetwarzania danych osobowych</span>
            <span class="new-line">
        ...
        <li>
          <p>
            <span class="strong">Prawo do przenoszenia danych osobowych</span>
            <span class="new-line">
              Użytkownikom przysługuje prawo uzyskania od Administratora, danych osobowych
              dotyczących Użytkownika w ustrukturyzowanym, powszechnie używanym formacie nadającym
              się do odczytu maszynowego, realizowane na żądanie złożone do Administratora</span
            >
          </p>
        </li>
        <li>
          <p>
            <span class="strong"
              >Prawo wniesienia sprzeciwu wobec przetwarzania danych osobowych </span
            ><span class="new-line"
